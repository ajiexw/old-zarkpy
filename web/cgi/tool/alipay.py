...
class alipay:
    def __init__(self,
                 ...
                 key="gvvqfk1cecbxgdg4f8hp2p54xbv8gbdd",
                 sellermail="369520295@qq.com",
                 notifyurl="http://aoaola.com/alipay-return",
                 returnurl="http://aoaola.com/alipay-return",
                 showurl="http://aoaola.com/alipay"):
