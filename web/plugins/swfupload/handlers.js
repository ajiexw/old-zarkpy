...
function addImage(src, img_id) {
    var img_html;
    if (img_id){
        img_html = '<div class="thumb_box left"><a class="swfupload_close" href="javascript:;" onclick="delImage(this, \''+img_id+'\')"  ></a><img src="'+src+'" /><input type="text" class="swfupload_alt" name="user_image_alt_'+img_id+'" value="为图片说点什么吧" onfocus="cleanValue(this);" onblur="addValue(this);"/></div>';
    }else{
